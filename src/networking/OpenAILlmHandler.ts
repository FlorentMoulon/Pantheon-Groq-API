...
export async function OpenAICallChatModel(systemPrompt: string, userPrompt: string, openAIKey: string, openAIOrgId: string, chatModel: string): Promise<string[] | null> {
...
export async function OpenAIGenerateChatComment(systemPrompt: string, userPrompts: string[], openAIKey: string, openAIOrgId: string, chatModel: string): Promise<{ text: string, chainOfThought: [ChainOfThoughtType, string][] } | null> {
  const data: ChatApiData = {
    model: chatModel,
...
export async function OpenAIGenerateBaseCompletions(prompt: string, openAIKey: string, openAIOrgId: string, baseModel: string, temperature: number): Promise<string[] | null> {
